            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              ...
              >
                <div className="flex flex-row gap-2 mb-2">
                  ...
                  <p className="text-white/80 font-semibold text-xs uppercase my-auto tracking-widest">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link href={currentSlideData.primaryButton.href}>
                    <Button variant="default">{currentSlideData.primaryButton.text}</Button>
                  </Link>
                  <Link href={currentSlideData.secondaryButton.href}>
                    <Button variant="outline">{currentSlideData.secondaryButton.text}</Button>
                  </Link>
                </div>
              </div>
            </div>
